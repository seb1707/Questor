...
namespace Questor.Modules.Lookup
{
    public class Time
    {
        ...
        public int ReloadWeaponDelayBeforeUsable_seconds = 18;              // Delay after reloading before that module is usable again (non-energy weapons), units: seconds. Default is 12
