...
namespace Questor.Modules.Lookup
{
    public class Time
    {
        ...
        public int QuestorBeforeLoginPulseDelay_milliseconds = 1000;        // Pulse Delay for Program.cs: Used to control the speed at which the program will retry logging in and retry checking the schedule
